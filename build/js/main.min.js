...
$((function(){$(".burger").on("click",(function(){$(this).parent().find(".menu").toggleClass("active"),$(this).toggleClass("active")})),showCategory(categoryList,categoryContent)}));const categoryList=$(".category span"),categoryContent=$(".category-content .grid-item");function showCategory(t,o){t.on("click",(function(t){const n=t.target.className;o.each((function(){"all"===n?$(o).show():$(this).hasClass(n)?$(this).show():$(this).hide()})),masonry()}))}function masonry(){$(".category-content").masonry({itemSelector:".grid-item",columnWidth:280})}
