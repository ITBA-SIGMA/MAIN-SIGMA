...
window.onscroll=function(){myFunction()};var nav=document.getElementsByClassName("left-sidebar")[0],sticky=nav.offsetTop;function myFunction(){window.pageYOffset>sticky?nav.classList.add("sticky"):nav.classList.remove("sticky")}
...
function openModal(){var l=document.getElementById("myModal");"flex"===l.style.display?l.style.display="none":l.style.display="flex"}var scrollIndex=1;function plusImg(l){showScrolls(scrollIndex+=l)}function currentImg(l){showScrolls(scrollIndex=l)}function showScrolls(l){var e,s=document.getElementsByClassName("myImgSlides"),n=document.getElementsByClassName("demo"),o=document.getElementById("caption");for(l>s.length&&(scrollIndex=1),l<1&&(scrollIndex=s.length),e=0;e<s.length;e++)s[e].style.display="none";for(e=0;e<n.length;e++)n[e].className=n[e].className.replace(" active","");s[scrollIndex-1].style.display="flex",n[scrollIndex-1].className+=" active",o.innerHTML=n[scrollIndex-1].alt}showScrolls(scrollIndex);
